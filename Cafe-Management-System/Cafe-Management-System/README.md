...
<img  src ="./naman-cafe-ER-Model.png" alt="ER-Model">
...
```sql
-- Drop namancafe database if it exists
DROP DATABASE IF EXISTS namancafe;

-- Create namancafe database
CREATE DATABASE namancafe;

-- Use namancafe database
USE namancafe;
...
VALUES ("Naman Pandey", "naman@gmail.com");
